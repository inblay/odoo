...
"use strict";
    ...
    var ProductKanbanController = KanbanController.extend({
        ...
        start: function () {
            this.$el.addClass('product_management_products d-flex');
        ...
        _update: function () {
            ...
            return this._super.apply(this, arguments).then(function () {
                ...
                if (!self.nonavigation_update) {
                    // we render the navigation panel only when needed to get new data.
                    // not each time when a tag or section are selected
                    self._renderNavigationPanel();
                };
        ...
        _renderNavigationPanel: function () {
            ...
            var defer = self._renderCategories();
            var defer_2 = self._renderEshopCategories();
            $.when(defer, defer_2).then(function () {
        ...
        _renderRightNavigationPanel: function () {
            ...
            if (selectedRecords.length) {
                self._rpc({
                    ...
                    self.$el.append($navigationPanel);
        ...
        _massActionExport: function(event) {
            ...
            new DataExport(this, record, ExportFields).open();
        },
        getActiveDomain: function () {
            // The method is required to construct export popup
            return $.Deferred().resolve([["id", "in", this.selectedRecords]]);
        },
    });
